...
public class WitheredGlassPane extends FourWayBlock {
   
	  
	public WitheredGlassPane() {
      super(1.0F, 1.0F, 16.0F, 16.0F, 16.0F, Block.Properties.create(Material.GLASS).hardnessAndResistance(.4f, 2f).sound(SoundType.GLASS).notSolid());
   ...
   public final boolean canAttachTo(BlockState p_220112_1_, boolean p_220112_2_) {
      ...
      return !cannotAttach(block) && p_220112_2_ || block instanceof WitheredGlassPane || block.isIn(BlockTags.WALLS);
   }
