...
public class NetherThatchStair extends Block implements IWaterLoggable  {
	public static final DirectionProperty FACING = HorizontalBlock.HORIZONTAL_FACING;
	   public static final EnumProperty<Half> HALF = BlockStateProperties.HALF;
	   public static final EnumProperty<StairsShape> SHAPE = BlockStateProperties.STAIRS_SHAPE;
	   public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
	   protected static final VoxelShape AABB_SLAB_TOP = NetherThatchSlab.TOP_SHAPE;
	   protected static final VoxelShape AABB_SLAB_BOTTOM = NetherThatchSlab.BOTTOM_SHAPE;
	   ...
	   public NetherThatchStair() {
	      
		super(Block.Properties.create(Material.PLANTS)
					.sound(SoundType.PLANT)
					.hardnessAndResistance(1f, 5f).harvestTool(ToolType.AXE)
					.harvestLevel(0));
	   ...
	   public static boolean isBlockStairs(BlockState state) {
	      return state.getBlock() instanceof NetherThatchStair;
	   }
