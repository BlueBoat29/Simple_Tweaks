...
public class RuinedWatchtowerPeice {
	...
	{
		JigsawManager.func_236823_a_(StructureRegister.locate("ruined_watchtower/"), 7, RuinedWatchtowerPeice.Piece::new, chunkGen, template, pos, pieces, seed, true, true);
	}
	...
	static
	{
		...
		registry.register("ruined_watchtower_1", registry.builder().names("ruined_watchtower_1").build());
	}
